...
//go:generate go tool mockgen -destination=../mock/idxkey_repository.go -mock_names=Repository=IDXKeyRepository -package=mock github.com/xescugc/rebost/idxkey Repository
