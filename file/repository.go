...
//go:generate go tool mockgen -destination=../mock/file_repository.go -mock_names=Repository=FileRepository -package=mock github.com/xescugc/rebost/file Repository
